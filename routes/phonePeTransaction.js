...
const phonePeTransaction = require('../controllers/phonePeTransaction.controller');
...
/**
 * @swagger
 * /transactions/phonepe:
 *   post:
 *     summary: Create new phonepe Order
 *     tags: [Transaction]
 *     requestBody:
 *       description: | 
 *          #
 ...
 */
router.post('/phonePeTransaction/phonepe',phonePeTransaction.createPhonePeOrder);

/**
 * @swagger
 * /transactions/phonepe/verify-payment-status:
 *   post:
 ...
 *         description: Internal server error
 */
router.post('/transactions/phonepe/verify-payment-status',phonePeTransaction.VerifyPaymentStatus);
 ...
 *         description: Internal server error
 */
router.post('/phonePeTransaction/create_web',phonePeTransaction.createNewTransactionWeb);
 ...
 *         description: Internal server error
 */
 router.post('/phonePeTransaction/create_upi',phonePeTransaction.createNewTransactionUPI);
